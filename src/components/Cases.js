        ...
        <SwiperSlide className="hidden lg:block">
          <div className="mt-8 bg-black sticky flex-1 pb-10 top-5 pt-1 ">
            ...
            <h4 className="px-2 mt-4 text-left lg:text-xl lg:text-center">
              Com o objetivo de criar um sistema onde doadores de sangue
              pudessem ter maior facilidade para encontrar, agendar e realizar
              doação de sangue no estado de Alagoas surgiu o Sangue Amigo na
              disciplina de programação web na UFAL.
            </h4>
          </div>
        </SwiperSlide>
        <SwiperSlide className="hidden lg:block">
